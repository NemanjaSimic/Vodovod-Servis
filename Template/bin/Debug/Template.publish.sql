...
CREATE TABLE [dbo].[KORISTI] (
    ...
    CONSTRAINT [KORISTI_PK] PRIMARY KEY CLUSTERED ([EKIPA_ID_EK] ASC, [NALAZI_U_ID_TIP] ASC, [NALAZI_U_ID_MAG] ASC, [NALAZI_U_ID_DEO] ASC)
);
...
GO
PRINT N'Creating [dbo].[FK_ASS_5]...';


GO
ALTER TABLE [dbo].[KORISTI] WITH NOCHECK
    ADD CONSTRAINT [FK_ASS_5] FOREIGN KEY ([EKIPA_ID_EK]) REFERENCES [dbo].[EKIPA] ([ID_EK]);


GO
PRINT N'Creating [dbo].[FK_ASS_6]...';


GO
ALTER TABLE [dbo].[KORISTI] WITH NOCHECK
    ADD CONSTRAINT [FK_ASS_6] FOREIGN KEY ([NALAZI_U_ID_TIP], [NALAZI_U_ID_MAG], [NALAZI_U_ID_DEO]) REFERENCES [dbo].[NALAZI_U] ([DEO_OPREME_ID_TIP], [MAGACIN_ID_MAG], [ID_DEO]);
...
ALTER TABLE [dbo].[KORISTI] WITH CHECK CHECK CONSTRAINT [FK_ASS_5];

ALTER TABLE [dbo].[KORISTI] WITH CHECK CHECK CONSTRAINT [FK_ASS_6];
